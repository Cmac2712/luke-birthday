			...
			<div class="fusion-important-notice fusion-auto-patcher">
				...
				<div class="fusion-patcher-heading">
					<p class="description">
						...
						<?php endif; ?>
						<span class="fusion-auto-patcher learn-more"><a href="https://theme-fusion.com/documentation/avada/install-update/avada-patcher/" target="_blank" rel="noopener noreferrer"><?php esc_html_e( 'Learn More', 'fusion-builder' ); ?></a></span>
					</p>
					<?php if ( ! empty( $available_patches ) ) : ?>
					...
					<table class="fusion-patcher-table">
						<tbody>
							<tr class="fusion-patcher-headings">
								<th style="min-width:6em;"><?php esc_html_e( 'Patch #', 'fusion-builder' ); ?></th>
								<th>
										...
										<?php if ( $can_apply ) : ?>
											<form method="post" action="options.php">
												...
												<?php if ( $patch_applied ) : ?>
													<?php submit_button( esc_html__( 'Patch Applied', 'fusion-builder' ) ); ?>
												<?php else : ?>
													<?php submit_button( esc_html__( 'Apply Patch', 'fusion-builder' ) ); ?>
													<?php if ( $patch_failed ) : ?>
														...
														<a class="button" style="margin-top:10px;font-size:11px;color:#b71c1c;display:block;" href="<?php echo esc_url_raw( $dismiss_url ); ?>"><?php esc_html_e( 'Dismiss Notices', 'fusion-builder' ); ?></a>
													<?php endif; ?>
												<?php endif; ?>
											</form>
										<?php else : ?>
