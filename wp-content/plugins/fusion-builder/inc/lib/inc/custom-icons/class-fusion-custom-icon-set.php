...
class Fusion_Custom_Icon_Set {
	...
	public function admin_head() {
		$uploader_options = [
			...
			'filters'             => [
				[
					'title'      => __( 'Allowed Files', 'fusion-builder' ),
					'extensions' => 'zip',
				],
			],
			'multipart'           => true,
	...
	public function add_duplicate_prefix_notice() {
		...
		if ( isset( $icon_set['css_prefix'] ) && true === $this->is_duplicate_prefix( $icon_set['css_prefix'] ) && class_exists( 'Fusion_Admin_Notice' ) ) {
			new Fusion_Admin_Notice(
				...
				'<p>' . esc_html__( 'Icon set with same CSS prefix already exists! Please use unique prefix in order to avoid conflicts.', 'fusion-builder' ) . '</p>',
				true,
				'error',
				true,
				'user_meta',
	...
	public function render_metabox() {
		...
		$buton_label     = $is_new_icon_set ? __( 'Browse Files', 'fusion-builder' ) : __( 'Update Custom Icon Set', 'fusion-builder' );
				...
				<div id="fusion-icons-uploader-wrapper" class="fusion-icons-uploader multiple">
					<div id="fusion-icons-uploader-drop-zone">
						<div>
							...
							<h3>
								<?php esc_html_e( 'Drop zip file to upload', 'fusion-builder' ); ?>
							</h3>
							<p>
								<?php
								printf(
							...
							<input id="fusion-icons-uploader-button" type="button" value="<?php esc_attr_e( 'Select File', 'fusion-builder' ); ?>" class="fusion-icons-uploader-button button">
			...
			<?php else : ?>
				...
				<div class="fusion-custom-icons-top-bar">
					...
					<div class="fusion-custom-icons-info">
						<span>
							<?php esc_html_e( 'CSS Prefix:', 'fusion-builder' ); ?>
						...
						<span>
							<?php esc_html_e( 'Icons Count:', 'fusion-builder' ); ?>
							<span class="fusion-custom-icons-value">
