...
class Fusion_FusionRedux {
	...
	public function enqueue() {
		...
		wp_localize_script(
			...
			[
				...
				'confirm' => esc_attr__( 'Are you sure you want to reset all Fusion caches?', 'fusion-builder' ),
				'success' => esc_attr__( 'All Fusion caches have been reset.', 'fusion-builder' ),
			]
		);
	}
	...
	public function admin_notice() {
		...
		<div id="remote-media-found-in-fusion-options" class="notice notice-error" style="position:relative;">
			<p><?php esc_html_e( 'Media fields using remote URLs were detected in your theme options:', 'fusion-builder' ); ?></p>
			...
			<p><?php esc_html_e( 'Please replace them with locally-imported files from your media-library', 'fusion-builder' ); ?></p>
			...
			<a href="javascript:;" id="dismiss-fusion-redux-ajax-notification" style="position:absolute;top:5px;right:5px;color:#dc3232;text-decoration:none;">
				...
				<span class="screen-reader-text"><?php esc_html_e( 'Dismiss Message', 'fusion-builder' ); ?></span>
			</a>
		</div>
		<?php
	}
